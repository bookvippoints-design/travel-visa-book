    ...
    <aside className="fixed left-0 top-0 h-screen w-56 flex flex-col z-40"
      ...
      <div className="px-4 py-2 border-b" style={{borderColor: 'rgba(255,255,255,0.05)'}}>
        <span className="text-xs font-semibold uppercase tracking-wider"
          style={{color: role === 'super_admin' ? '#B8860B' : '#64748b'}}>
          {role === 'super_admin' ? '★ Super Admin' : 'Empresa'}
        </span>
      </div>
      ...
      <div className="p-3 border-t" style={{borderColor: 'rgba(255,255,255,0.08)'}}>
        ...
        <button onClick={handleLogout}
          className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm transition-all text-gray-400 hover:text-white hover:bg-white/10">
